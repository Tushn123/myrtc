...
#ifndef  ICE_ICE_CONNECTION_H_
#define  ICE_ICE_CONNECTION_H_
...
public:
    ...
    IceConnection(rtc::Thread* network_thread, UDPPort* port, const Candidate& remote_candidate);
#endif
    ~IceConnection();
